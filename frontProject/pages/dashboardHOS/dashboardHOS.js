var dashboardHOS = Backbone.View.extend({
    el: $(appData.router.renderPageTo),
    template 		: 'dashboardHOS',
    searchTimeout 	: 1,
    ...
    initialize: function(){
        ...
        appData.api.request('sales/getDashboard', {}, function(resp, success){
            // data loaded, load template for parsing the data
            resp.turnover.total = resp.turnover.cash + resp.turnover.card + resp.turnover.online;
    ...
    trueRender: function(resp){
        ...
        $.get("/pages/"+this.template+"/" + this.template + ".html", function(template){
            ...
            that.renderCharts(resp);
        });

        return this;
    },

    renderCharts: function(resp){
        // Generate chart
        ...
        //     data: {
        //         columns: [
        //             ['Наличными', data.turnover.cash],
        //             ['Картой курьеру', data.turnover.card],
        //             ['Картой онлайн', data.turnover.online],
        //         ],
        //         type : 'pie'
        //     }
        // });
    ...
    // Initialize chart
    campaignDonut("#c3-pie-chart", 180);
    dailyRevenue('#today-revenue', 115); // initialize chart
    ...
    function campaignDonut(element, size) {
        ...
        var data = [
            {
                "browser": "Наличными",
                "icon": "<i class='icon-coin-dollar position-left'></i>",
                "value": resp.turnover.cash,
                "color" : "#66BB6A"
            }, {
                "browser": "Картой курьеру",
                "icon": "<i class='icon-credit-card position-left'></i>",
                "value": resp.turnover.card,
                "color": "#9575CD"
            }, {
                "browser":"Картой онлайн",
                "icon": "<i class='fa fa-globe position-left'></i>",
                "value": resp.turnover.online,
                "color": "#FF7043"
            }
        ];
...
appData.BackboneViews.DashboardHOS = new dashboardHOS();